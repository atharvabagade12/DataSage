<template>
  <div class="data-preview">
    <PageHeader 
      title="Data Preview & Preprocessing" 
      description="Inspect your raw data and apply transformations to ensure maximum quality before training."
    >
      <template #icon>
...
onBeforeRouteLeave((to, _from, next) => {
  ...
  if (mlStore.isDirty) {
    ...
    // Clear session when leaving the pipeline
